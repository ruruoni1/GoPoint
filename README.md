...
* 자동 업데이트 확인이 겹칠 때 결과가 섞이던 문제를 수정했습니다.
* 업데이트 후 새 실행 파일 재시작과 기존 프로세스 종료 흐름을 안정화했습니다.
* 사용자가 바꾼 `Default` 프로필이 재시작 후 덮어써지던 문제를 수정했습니다.
* 최신 배포 파일: **[GoPoint_v1.0.9.exe](https://github.com/ruruoni1/GoPoint/releases/latest)**
...
2. `GoPoint_v1.0.9.exe` (가장 최신 버전) 파일을 다운로드합니다.
